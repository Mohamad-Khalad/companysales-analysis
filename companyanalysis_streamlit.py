...
st.sidebar.image(r"E:\DATA SCIENCE GEEK\ITI Intensive Camp\PowerBI Cairo 2024\1.Python\4.Python_Day_4\Python - DataCleaning-20240529T153753Z-001\sidebarimg.jpeg")
...
if sidebar_var == "PowerBI Dashboard":
    ...
    st.image(r"C:\Users\DELL\Downloads\companysales_jpeg.jpg",width=1000)
    ...
    st.image(r"C:\Users\DELL\Downloads\profile.png",width=500,channels="RGB")
